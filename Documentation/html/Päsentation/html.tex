...
\item Und wie könnte die zum Beispiel aussehen?
...
\end{lstlisting}
\pause
\fcolorbox{red}{white}{\parbox{\linewidth}{\begin{center}Wichtig: Fast alle Tags, die ge\"offnet werden, müssen zwingend wieder geschlossen werden. \end{center}}}
\end{frame}
...
Fügt eure erste Überschrift ein und schreibt direkt danach einen kleinen Paragraphen zu eurer Website.
\end{frame}
...
Bindet z.B. eure Facebook- oder Instagramseite ein, die Youtube-Startseite oder die Website einer Tageszeitung.
\end{frame}
...
Iframes benötigen wir beispielsweise beim Einbinden von Gifs:
\begin{lstlisting}
...
\\
Mit der Ergänzung \textit{allowfullscreen} könnt ihr dem Nutzer das Video sogar im Vollbildmodus zeigen.
\end{frame}
