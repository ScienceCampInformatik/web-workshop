...
\begin{frame}[fragile]{Allgemeiner Aufbau}
	...
	Erinnerung: Grundgerüst
\end{frame}

\section{Überschriften}
\begin{frame}[fragile]{Überschriften und Paragraphen}
\begin{itemize}
...
%\end{lstlisting} 
\item Nicht schön? Nicht schlimm, das gestalten wir später noch!
\end{itemize}
\end{frame}
...
Fügt eure erste Überschrift in eure Website ein und schreibt direkt danach einen kleinen Paragraphen zu eurer Webseite.
\end{frame}

\section{Kommentare}
\begin{frame}[fragile]{Kommentare}
Um die Übersicht zu behalten, sind manchmal Kommentare sehr hilfreich!
\pause
\begin{lstlisting}
<body>
<h1>Hier steht eure Überschrift</h1>
<!-- Kommentar --> 
...
\textbf{Jetzt wird endlich alles schöner!} \\
...
\begin{frame}[fragile]{Styles}
Mit dem Style-Attribut könnt ihr jetzt unterschiedliche Elemente kreativer gestalten. Zum Beispiel:
\begin{itemize}
...
\begin{lstlisting}
<body>
	<h1 style="font-size:300%;">Das ist eine Überschrift</h1>
...
\begin{lstlisting}
<body>
	<h1 style="text-align:center;">Das ist eine Überschrift</h1>
...
Gestaltet eure Seite mit einer Hintergrund- und unterschiedlichen Textfarben und richtet Texte aus, wie es euch am besten gefällt, aber auch sinnvoll ist.
\end{frame}

\section{Links}
\begin{frame}[fragile]{Links}
Nun binden wir Links ein, um von unserer Website zu anderen Internetseiten schnell wechseln zu können.
\pause
\\
Dazu verwenden wir:
\begin{lstlisting}
...
Als nächstes fügen wir Bilder hinzu mit:
\begin{lstlisting}
<img src="url">
\end{lstlisting}
\pause
...
\begin{frame}[fragile]{Bilder}
\begin{center}
\textbf{Endlich können wir süße Tierbilder \\ einfügen!}
\begin{figure}
	\centering
	\includegraphics[width=0.4\textwidth]{igel.jpg}
\end{figure}
Und genau das machen wir jetzt auch: Sucht euch ein Bild oder mehrere mit einem Motiv eurer Wahl und fügt sie in eure Website unter euren Paragraphen ein.
\end{center}
\end{frame}

\begin{frame}[fragile]{Iframes}
Um Gifs einzufügen, brauchen wir iframes:
\begin{lstlisting}
<iframe src="url"> </iframe>
\end{lstlisting}

%\includemovie{1cm}{1cm}{unicorn.gif}
\includegraphics{unicorn.gif}

\pause
Höhe und Breite legen wir so fest:
\begin{lstlisting}
...
\begin{frame}[fragile]{Iframes}
Die Umrandung ist nicht schön? Kein Problem, ein kleiner Trick:
\begin{lstlisting}
...
Sucht euch auf giphy.com ein cooles Gif aus und fügt es über oder unter eurem Bild ein. 
\end{frame}
...
\item von Dingen, die ihr irgendwann mal machen möchtet!
\end{itemize}
\end{frame}
